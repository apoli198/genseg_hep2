...
seg_save_path = f'./end2end_HEp2_model/end2end-HEp2-{opt.seg_model}'
os.makedirs(seg_save_path, exist_ok=True)
opt_path = os.path.join(seg_save_path, "train_options.pkl")
with open(opt_path, "wb") as f:
    pickle.dump(opt, f)
log_file_path = os.path.join("./plots/end2end", "output.log")
...
if __name__ == "__main__":
   ...
   # --------------------------- 
    for fold in range(0, num_folds):
        command = [
            "python", "running_files/train_end2end_hep2_fold.py",
            "--fold", str(fold),
            "--opt_path", opt_path,
